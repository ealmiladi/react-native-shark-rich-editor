...
<head>
    ...
    <style>
        * {outline: 0px solid transparent;-webkit-tap-highlight-color: rgba(0,0,0,0);-webkit-touch-callout: none;}
        ...
        img {max-width: 100px; max-height: 100px; object-fit: contain; margin: 4px 0; border-radius: 10px; margin-left:auto;margin-right:auto;display: block;}
    ...
    (function (exports) {
        ...
        var Actions = {
            ...
            image: {
                result: function(url) {
                    if (url){
                        exec('insertHTML', "<div><img src='"+ url +"' style='height: 100px'/></div><br>");
        ...
        var init = function init(settings) {
            ...
            addEventListener(content, 'paste', async function (e) {
